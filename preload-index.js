...
contextBridge.exposeInMainWorld('api', {
  ...
  orders: {
    ...
    update: (params) => ipcRenderer.invoke('orders:update', params),
  ...
  credits: {
    ...
    create:         (params) => ipcRenderer.invoke('credits:create', params),
    update:         (params) => ipcRenderer.invoke('credits:update', params),
    recordPayment:  (params) => ipcRenderer.invoke('credits:record-payment', params),
    paymentHistory: (params) => ipcRenderer.invoke('credits:payment-history', params),
    allPayments:    (params) => ipcRenderer.invoke('credits:all-payments', params),
    writeOff:       (params) => ipcRenderer.invoke('credits:write-off', params),
    overdue:        (params) => ipcRenderer.invoke('credits:overdue', params),
    aging:          (params) => ipcRenderer.invoke('credits:aging', params),
    clientSummary:  (params) => ipcRenderer.invoke('credits:client-summary', params),
    rules: {
  ...
  // Expenses
  expenses: {
    list:           (params) => ipcRenderer.invoke('expenses:list', params),
    create:         (params) => ipcRenderer.invoke('expenses:create', params),
    update:         (params) => ipcRenderer.invoke('expenses:update', params),
    delete:         (params) => ipcRenderer.invoke('expenses:delete', params),
    summary:        (params) => ipcRenderer.invoke('expenses:summary', params),
    byCategory:     (params) => ipcRenderer.invoke('expenses:by-category', params),
    overTime:       (params) => ipcRenderer.invoke('expenses:over-time', params),
    profitLoss:     (params) => ipcRenderer.invoke('expenses:profit-loss', params),
    categories: {
      list:   (params) => ipcRenderer.invoke('expenses:categories-list', params),
      save:   (params) => ipcRenderer.invoke('expenses:categories-save', params),
      delete: (params) => ipcRenderer.invoke('expenses:categories-delete', params)
    }
  },
